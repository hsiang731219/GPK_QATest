...
element = WebUI.getAttribute(findTestObject('Home/Index_Page/txt_TodayValidBet'), 'title')
...
StatisticsAttribute = WebUI.getAttribute(findTestObject('Statistics/Index_Page/txt_StatisticsValidBet'),'title')
