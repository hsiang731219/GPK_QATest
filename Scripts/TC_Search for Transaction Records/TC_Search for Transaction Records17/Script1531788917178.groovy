...
'實際存提選擇「否」'
WebUI.selectOptionByLabel(findTestObject('MemberTransaction/Index_Page/select_RealDeposit_Withdrawal'), '否', false)
...
WebUI.verifyElementNotChecked(findTestObject('MemberTransaction/Detail_Page/CheckBox_ManuallyDepositAndWithdrawal'), 30)
