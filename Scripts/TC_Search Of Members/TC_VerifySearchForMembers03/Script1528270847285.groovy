...
'輸入帳戶餘額起始金額'
WebUI.setText(findTestObject('Object Repository/Member/Index_Page/input_BalanceBegin'), '2')

'輸入帳戶餘額結束金額'
WebUI.setText(findTestObject('Object Repository/Member/Index_Page/input_BalanceEnd'), '5')
...
after = WebUI.getText(findTestObject('Object Repository/Member/Index_Page/txt_BalanceText'))
