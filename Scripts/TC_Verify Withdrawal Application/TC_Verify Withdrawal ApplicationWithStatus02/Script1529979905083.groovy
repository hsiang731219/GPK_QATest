...
'勾選「已退回」'
WebUI.click(findTestObject('VerifyWithdraw/Search_Page/checkbox_Cancel'))

'得到「已退回」文字'
beforetext = WebUI.getText(findTestObject('VerifyWithdraw/Search_Page/checkbox_Cancel'))
