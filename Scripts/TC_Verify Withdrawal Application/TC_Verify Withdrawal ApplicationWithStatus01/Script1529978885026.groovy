...
'勾選「已出款」'
WebUI.click(findTestObject('VerifyWithdraw/Search_Page/checkbox_Deposited'))

'得到「已出款」文字'
beforetext = WebUI.getText(findTestObject('VerifyWithdraw/Search_Page/checkbox_Deposited'))
