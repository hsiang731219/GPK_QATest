...
'優惠稽核'
WebUI.click(findTestObject('Member/Deposit_Page/inputRadio_PromotionAudit'))

'稽核金額'
WebUI.setText(findTestObject('Member/Deposit_Page/input_AuditAmount'), '1')

'优惠活动'
WebUI.selectOptionByLabel(findTestObject('Member/Deposit_Page/select_DepositOption'), '优惠活动', false)
...
WebUI.verifyEqual(GetAfterTransactionType, '优惠活动')
