...
WebUI.setText(findTestObject('Group/Create_Page/input_BankAccount'), 'QA測試銀行(有寫備註)')
...
WebUI.setText(findTestObject('Group/Create_Page/textarea_Memo'), '測試新增')
...
'取得 備註 文字'
verify_Memo = WebUI.getText(findTestObject('Group/Detail_Page/div_Memo'))
