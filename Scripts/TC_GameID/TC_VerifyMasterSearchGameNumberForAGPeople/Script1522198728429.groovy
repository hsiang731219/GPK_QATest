...
'選擇AG 真人'
WebUI.click(findTestObject('BetRecord/Category_Page/label_AG_People'))
...
'把AG局號存下來'
txt_AG_People_GameID = WebUI.getText(findTestObject('BetRecord/Detail_Page/txt_AGPeopleGameID'))
...
'取得AG 真人 的GameID'
txt_AG_People_gameID_Verify = WebUI.getText(findTestObject('BetRecord/Detail_Page/txt_AGPeopleGameID'))
