...
'選擇 CQ9 Slot'
WebUI.click(findTestObject('BetRecord/Category_Page/label_CQ9_Slot'))
...
'把CQ9 Slot 局號存下來'
txt_CQ9_Fish_GameID = WebUI.getText(findTestObject('BetRecord/Detail_Page/txt_CQ9FishGameID'))

WebUI.back()

'把CQ9 Slot 局號填入局號的欄位'
WebUI.setText(findTestObject('BetRecord/Index_Page/input_GameID'), txt_CQ9_Fish_GameID)
...
'取得CQ9 Fish的GameID'
txt_CQ9_Fish_gameID_Verify = WebUI.getText(findTestObject('BetRecord/Detail_Page/txt_CQ9FishGameID'))

'確定局號是否正確'
WebUI.verifyMatch(txt_CQ9_Fish_GameID, txt_CQ9_Fish_gameID_Verify, true)
