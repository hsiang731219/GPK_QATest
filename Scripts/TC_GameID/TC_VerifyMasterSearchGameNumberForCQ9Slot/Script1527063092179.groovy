...
'選擇 CQ9 Slot'
WebUI.click(findTestObject('BetRecord/Category_Page/input_CQ9_Slot'))
...
'把CQ9 Slot 局號存下來'
txt_CQ9_Slot_GameID = WebUI.getText(findTestObject('BetRecord/Detail_Page/div_CQ9_Slot_GameID'))

WebUI.back()

'把CQ9 Slot 局號填入局號的欄位'
WebUI.setText(findTestObject('BetRecord/Index_Page/input_GameID'), txt_CQ9_Slot_GameID)
...
'取得CQ9 Fish的GameID'
txt_CQ9_Slot_gameID_Verify = WebUI.getText(findTestObject('BetRecord/Detail_Page/div_CQ9_Slot_GameID'))

'確定局號是否正確'
WebUI.verifyMatch(txt_CQ9_Slot_GameID, txt_CQ9_Slot_gameID_Verify, true)
