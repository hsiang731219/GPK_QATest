...
'選擇返水設定'
WebUI.click(findTestObject('Agent/Index_Page/select_Rebate Setting'))

WebUI.delay(1)

'狀態選擇「abby-返」'
WebUI.selectOptionByLabel(findTestObject('Agent/Index_Page/select_Rebate Setting'), 'abby-返', false)
...
'取得查詢結果的會員狀態'
aftertext = WebUI.getText(findTestObject('Agent/Detail_Page/text_Rebate Setting'))
