...
'設置在Excel的資料位置'
IndexOfThirdPartyTC.setIndexTC(7)
 ...
 */
'類型'
WebUI.verifyElementText(findTestObject('Group/ThirdParty/Detail_Page/table_Type_eBank'), Info.type)

'商戶號'
WebUI.verifyElementText(findTestObject('Group/ThirdParty/Detail_Page/table_accountNumber_eBank'), Info.accountNumber)

'商户证书'
WebUI.verifyElementText(findTestObject('Group/ThirdParty/Detail_Page/table_merchantCertificate_eBank'), Info.merchantCertificate)

'跳板網址'
WebUI.verifyElementText(findTestObject('Group/ThirdParty/Detail_Page/table_Gateway'), Info.gateway)
