...
'輸入Email'
WebUI.setText(findTestObject('ThirdParty/Create_Page/input_PaymentInfo3'), Info.Email)

'輸入跳板网址'
WebUI.setText(findTestObject('ThirdParty/Create_Page/input_PaymentInfo4'), Info.gateway)
...
'Email'
WebUI.verifyElementText(findTestObject('ThirdParty/ThirdParty_Exist/table_Text4'), Info.Email)

'跳板網址'
WebUI.verifyElementText(findTestObject('ThirdParty/ThirdParty_Exist/table_Text5'), Info.gateway)
