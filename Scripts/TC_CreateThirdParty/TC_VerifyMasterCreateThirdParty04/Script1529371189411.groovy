...
'設置在Excel的資料位置'
IndexOfThirdPartyTC.setIndexTC(5)
...
'輸入Email'
WebUI.setText(findTestObject('Group/ThirdParty/Create_Page/input_gateway_eBank'), Info.Email)

'輸入跳板网址'
WebUI.setText(findTestObject('Group/ThirdParty/Create_Page/input_CallbackKey_WapAlipay'), Info.gateway)
...
'Email'
WebUI.verifyEqual(WebUI.getText(findTestObject('Group/ThirdParty/Detail_Page/table_Email_Alipay')), Info.Email)

'跳板網址'
WebUI.verifyElementText(findTestObject('Group/ThirdParty/Detail_Page/table_CallbackKey_WapAlipay'), Info.gateway)
